...
import static org.onebusaway.utility.InterpolationLibrary.interpolate;
...
public class InterpolationLibraryTest {
  ...
  public void testLastValueOnOutOfRange() {
    ...
    assertEquals(0.0, interpolate(values, -0.25,EOutOfRangeStrategy.LAST_VALUE), 0.0);
    assertEquals(0.0, interpolate(values, 0.0,EOutOfRangeStrategy.LAST_VALUE), 0.0);
    assertEquals(4.0, interpolate(values, 1.5,EOutOfRangeStrategy.LAST_VALUE), 0.0);
    assertEquals(6.0, interpolate(values, 2.0,EOutOfRangeStrategy.LAST_VALUE), 0.0);
    assertEquals(6.0, interpolate(values, 2.25,EOutOfRangeStrategy.LAST_VALUE), 0.0);
  }
  ...
  public void testInterpolateOnOutOfRange() {
    ...
    assertEquals(-1.5, interpolate(values, -0.75,EOutOfRangeStrategy.INTERPOLATE), 0.0);
    assertEquals(0.0, interpolate(values, 0.0,EOutOfRangeStrategy.LAST_VALUE), 0.0);
    assertEquals(4.0, interpolate(values, 1.5,EOutOfRangeStrategy.LAST_VALUE), 0.0);
    assertEquals(6.0, interpolate(values, 2.0,EOutOfRangeStrategy.LAST_VALUE), 0.0);
    assertEquals(7.0, interpolate(values, 2.25,EOutOfRangeStrategy.INTERPOLATE), 0.0);
  }
}
