...
/**
 * Trivial implementation of the ScheduleHelperService. That is, it does
 * nothing.
 *
 */
@Component
public class TrivialSchedulerHelperService implements ScheduleHelperService {
  ...
  @Override
  public Boolean routeHasUpcomingScheduledService(String agencyId, long time,
      String routeId, String directionId) {
    return null;
  }

  @Override
  public Boolean stopHasUpcomingScheduledService(String agencyId, long time,
      String stopId, String routeId, String directionId) {
    return null;
  }
  ...
  public Boolean stopHasRevenueServiceOnRoute(String agencyId, String stopId,
    ...
    for (BlockStopTimeIndex bsti : stopTimeIndicesForStop) {
      ...
      for (BlockStopTimeEntry bste : stopTimes) {
        ...
        if (routeId != null
            && !theTrip.getRoute().getId().equals(
                AgencyAndIdLibrary.convertFromString(routeId))) {
          continue;
        }
        ...
        /*
         * If at least one stoptime on one trip (subject to the route and
         * direction filters above) permits unrestricted pick-up or drop-off at
         * this stop (type=0), then it is considered a 'revenue' stop.
         */
