...
public class StopTimeSearchOperations {
  ...
  public static List<StopTimeInstanceProxy> getStopTimeInstancesInRange(
      ...
      Map<LocalizedServiceId, List<Date>> serviceIdsAndDates) {
    ...
    Map<LocalizedServiceId, List<StopTimeEntry>> serviceIdAndStopTimesSortedByStopTimeOp = index.getServiceIdAndStopTimesSortedByStopTimeOp(stopTimeOp);

    for (Map.Entry<LocalizedServiceId, List<Date>> entry : serviceIdsAndDates.entrySet()) {
  ...
  public static StopTimeIndexResult getPreviousStopTimeArrival(
    ...
    return h.getPreviousStopTime(index, context, currentTime);
  }
  ...
  public static StopTimeIndexResult getNextStopTimeDeparture(
    ...
    return h.getNextStopTime(index, context, currentTime);
  }
