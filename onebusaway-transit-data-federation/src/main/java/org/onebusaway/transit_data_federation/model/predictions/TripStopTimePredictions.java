...
public final class TripStopTimePredictions implements Serializable {
  ...
  public SortedMap<Integer, StopTimePrediction> getStopTimePredictionsByScheduledTime() {
    return Collections.unmodifiableSortedMap(_predictionsByScheduledTime);
  }
  ...
  /**
   * @param time seconds since midnight of service date
   * @return
   */
