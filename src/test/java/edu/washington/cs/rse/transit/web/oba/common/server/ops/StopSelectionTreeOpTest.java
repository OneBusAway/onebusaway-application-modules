...
public class StopSelectionTreeOpTest extends TestCase {
    public void testSimple() throws InterruptedException {
        ...
        StopSelectionService service = (StopSelectionService) context.getBean("stopSelectionServiceImpl");
        StopSelectionTreeOp op = new StopSelectionTreeOp(dao, service);
