 ...
 * the License.
 */
package org.onebusaway.common.web.common.client.resources;
...
public class StopIconFactory {
  ...
  private static CommonResources r = CommonResources.INSTANCE;
  ...
  public static Icon getIconForDirection(StopBean stop, boolean isSelected) {

    Icon icon = Icon.newInstance();
    icon.setImageURL(_directionIcons.get(stop.getDirection()));
