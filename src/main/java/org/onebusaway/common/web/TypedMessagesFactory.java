 ...
 * the License.
 */
package org.onebusaway.common.web;
...
public class TypedMessagesFactory extends AbstractFactoryBean {
  ...
  private static Logger _log = Logger.getLogger(TypedMessagesFactory.class.getName());
  ...
  protected Object createInstance() throws IOException {
    ...
    for (Method method : _messagesClass.getDeclaredMethods()) {
      if (!p.containsKey(method.getName()))
        _log.warning("missing message name: messagesType="
