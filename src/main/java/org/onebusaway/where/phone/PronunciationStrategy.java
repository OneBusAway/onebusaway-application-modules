 ...
 * the License.
 */
package org.onebusaway.where.phone;

import org.onebusaway.common.replacement.DefaultReplacementStrategy;
import org.onebusaway.common.replacement.DigitReplacementStrategy;
import org.onebusaway.common.replacement.IReplacementStrategy;
import org.onebusaway.common.replacement.NameNormalizationStrategy;
...
public class PronunciationStrategy {
  ...
  public void setNameNormalizationStrategy(
      NameNormalizationStrategy normalization) {
  ...
  public PronunciationStrategy() {
    ...
    addReplacement("des moines",
        "<phoneme ph=\"d eh m oy n\">desmoines</phoneme>");
    addReplacement("enumclaw",
        "<phoneme ph=\"j uw n eh m k l aa\">enumclaw</phoneme>");
    addReplacement("fauntleroy",
        "<phoneme ph=\"f ao n t t l eh r oy\">fauntleroy</phoneme>");
    addReplacement("fremont",
        "<phoneme ph=\"f r i1 m aa1 n t\">fremont</phoneme>");
    addReplacement("laurelhurst",
        "<phoneme ph=\"l ao1 r ah l h er1 s t\">laurelhurst</phoneme>");
    addReplacement("madrona",
        "<phoneme ph=\"m uh1 d r ow n ah\">madrona</phoneme>");
    addReplacement("puyallup",
        "<phoneme ph=\"p j1 uw aa l ah p\">puyallup</phoneme>");
    addReplacement("sammamish",
        "<phoneme ph=\"s ah m ae1 m ih sh\">sammamish</phoneme>");
    addReplacement("tacoma", "<phoneme ph=\"t aa k ow1 m ah\">tacoma</phoneme>");
    addReplacement("tukwila",
        "<phoneme ph=\"t ah k w ih1 l ah\">tukwila</phoneme>");
    addReplacement("wedgwood",
        "<phoneme ph=\"w eh d jh w uh d\">wedgwood</phoneme>");

    _replacements.add(new DigitReplacementStrategy());
  }

  public String getRouteNumberAsText(String route) {

    boolean express = false;

    if (route.endsWith("E")) {
      express = true;
      route = route.replaceAll("E$", "");
    }
  ...
  public String getStopNumberAsText(String id) {
  ...
  public String getStopNameAsText(String stopName) {
    return getDestinationAsText(stopName);
  }
