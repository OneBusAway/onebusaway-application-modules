 ...
 * the License.
 */
package org.onebusaway.where.web.common.client;
...
import org.onebusaway.where.web.common.client.rpc.NoSuchServicePatternServiceException;
...
import org.onebusaway.where.web.common.client.url.ParaUrlCodingStrategy;
import org.onebusaway.where.web.common.client.url.UrlCodingStrategy;
...
public class AbstractApplication implements EntryPoint, HistoryListener {
  ...
  public void onModuleLoad() {
    ...
    ServiceDefTarget target = (ServiceDefTarget) WhereServiceAsync.SERVICE;
  ...
  private String getServiceEntryPoint() {
    if (Location.getHost().equals("localhost:8888"))
      return "http://localhost:8888/org.onebusaway.where.web.standard.OneBusAwayStandardApplication/services/where";

    String path = Location.getPath();
    if (path.startsWith("/org.onebusaway"))
      return Location.getProtocol() + "//" + Location.getHost()
          + "/org.onebusaway/services/where";

    return Location.getProtocol() + "//" + Location.getHost() + "/services/where";
  }
