...
import org.onebusaway.where.web.common.client.model.StopsWithArrivalsBean;
...
public class StopByNumberAction extends ActionSupport {
  ...
  private StopsWithArrivalsBean _result;
  ...
  /**
   * Supports two styles of URL. It can be comma-seperated,
   * or route= can be given multiple times.
   */
  ...
  public StopsWithArrivalsBean getResult() {
    return _result;
  }
  ...
  public String execute() throws ServiceException {
    ...
    for(String id : _ids) {
      StopWithArrivalsBean result = _service.getArrivalsByStopId(id);
      stops.add(result.getStop());
      arrivals.addAll(result.getPredictedArrivals());
    }
    ...
    _result = new StopsWithArrivalsBean(stops, filtered);
  ...
  public String getArrivalLabel(DepartureBean pab, long now) {
    ...
    if( StatusService.STATUS_CANCELLED.equals(pab.getStatus()))
      return "suspended";
