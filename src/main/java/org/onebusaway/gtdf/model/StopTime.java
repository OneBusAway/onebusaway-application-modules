...
@Entity
@Table(name = "gtdf_stop_times")
@AccessType("field")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY)
@CsvFields(filename = "stop_times.txt")
public class StopTime extends IdentityBean<Integer> implements
    Comparable<StopTime> {
  ...
  @CsvField(mapping = org.onebusaway.gtdf.serialization.StopTimeFieldMappingFactory.class)
  ...
  public int compareTo(StopTime o) {
    return this.departureTime == o.departureTime ? 0
        : (this.departureTime < o.departureTime ? -1 : 1);
  }
}
