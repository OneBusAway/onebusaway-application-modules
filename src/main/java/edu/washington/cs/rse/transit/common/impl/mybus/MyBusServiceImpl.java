...
public class MyBusServiceImpl implements MyBusService {
    ...
    public List<BusArrivalEstimateBean> getSchedule(int mybusId) throws IOException, NoSuchStopException {
        return getSchedule(mybusId, MYBUS_WINDOW_PRE_IN_MINUTES, MYBUS_WINDOW_POST_IN_MINUTES);
    }
     ...
     *            MyBus stop id
     * @param timeBefore -
     *            window size in minutes to include into the past
     * @param timeAfter -
     *            window size in minutes to include into the future
     * @return a list of bus arrival estimates
     * @throws IOException
     * @throws NoSuchStopException
     */
    public List<BusArrivalEstimateBean> getSchedule(int mybusId, int timeBefore, int timeAfter) throws IOException,
            NoSuchStopException {
