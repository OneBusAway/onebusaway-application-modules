...
public class CustomStopByNumberPage extends StopByNumberPage {
  
  public Widget create(final Context context) {

    String id = context.getParam("id");
    final String url = "stop.action?id=" + id;

    FlowPanel panel = new FlowPanel();
    panel.addStyleName("panel");

    DivWidget description = new DivWidget(
        "The web app stop page has been updated and URLs have changed.");
