...
public class SelectionName implements Serializable {
    ...
    public SelectionName(String type, String name, String... names) {
        _type = type;
        _names.add(name);
        for (String n2 : names)
            _names.add(n2);
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof SelectionName))
            return false;
        SelectionName bean = (SelectionName) obj;
