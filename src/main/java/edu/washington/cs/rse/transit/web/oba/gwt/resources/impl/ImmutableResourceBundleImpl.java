...
import edu.washington.cs.rse.transit.web.oba.gwt.resources.URLStrategy;
...
public class ImmutableResourceBundleImpl implements ImmutableResourceBundle,
  ...
  protected String constructURL(String resourceName, String resourceKey,
      String resourceExtension) {
    return _urlStrategy.construct(_bundleName, resourceName, resourceKey,
        resourceExtension);
  }
