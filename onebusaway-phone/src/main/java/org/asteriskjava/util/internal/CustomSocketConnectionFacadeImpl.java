 ...
 */
public class CustomSocketConnectionFacadeImpl implements SocketConnectionFacade
{
     ...
     */
    public CustomSocketConnectionFacadeImpl(String host, int port, boolean ssl, int timeout, int readTimeout) throws IOException
    {
     ...
     * @throws IOException if the connection cannot be established.
     */
    public CustomSocketConnectionFacadeImpl(String host, int port, boolean ssl, int timeout, int readTimeout, Pattern lineDelimiter) throws IOException
    {
        Socket socket;
     ...
     */
    CustomSocketConnectionFacadeImpl(Socket socket) throws IOException
    {
