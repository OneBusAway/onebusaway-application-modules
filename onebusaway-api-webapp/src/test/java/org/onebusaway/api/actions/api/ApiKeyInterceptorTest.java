...
public class ApiKeyInterceptorTest  {
  ...
  public void setup() throws Exception {
    ...
    when(mockContentTypeHandlerManager.handleResult((ActionConfig) anyObject(), anyObject(), anyObject())).thenReturn("SUCCESS");
  ...
  */
  ...
  public void testUnauthorized401() throws Exception {
    ...
    verify(mockContentTypeHandlerManager).handleResult((ActionConfig) anyObject(), methodResultCaptor.capture(), responseCaptor.capture());
