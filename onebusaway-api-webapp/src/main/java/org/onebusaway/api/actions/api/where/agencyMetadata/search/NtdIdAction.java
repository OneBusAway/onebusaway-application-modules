...
public class NtdIdAction extends ApiActionSupport {
	  private static Logger _log = LoggerFactory.getLogger(NtdIdAction.class);
	  ...
	  public NtdIdAction(int defaultVersion) {
	  ...
	  public DefaultHttpHeaders show() throws IOException, ServiceException {
	    ...
	    List<AgencyMetadata> agencyMetadata =  _agencyMetadataService.getAgencyMetadataForNtdId(id);
