...
public class NameAction extends ApiActionSupport {
	  private static Logger _log = LoggerFactory.getLogger(NameAction.class);
	  ...
	  public NameAction(int defaultVersion) {
	  ...
	  public DefaultHttpHeaders show() throws IOException, ServiceException {
	    ...
	    List<AgencyMetadata> agencyMetadata =  _agencyMetadataService.getAgencyMetadataForName(id);
