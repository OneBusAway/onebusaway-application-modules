...
public class ShortNameAction extends ApiActionSupport {
	  private static Logger _log = LoggerFactory.getLogger(ShortNameAction.class);
	  private static final int V2 = 2;
	  private String id;
	  
	  public ShortNameAction() {
	    super(V2);
	  }
	  
	  public ShortNameAction(int defaultVersion) {
	  ...
	  public DefaultHttpHeaders show() throws IOException, ServiceException {
	    ...
	    List<AgencyMetadata> agencyMetadata =  _agencyMetadataService.getAgencyMetadataForShortName(id);
