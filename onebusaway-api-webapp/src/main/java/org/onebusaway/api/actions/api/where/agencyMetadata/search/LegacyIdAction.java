...
public class LegacyIdAction extends ApiActionSupport {
	  private static Logger _log = LoggerFactory.getLogger(LegacyIdAction.class);
	  private static final int V2 = 2;
	  private String id;
	  
	  public LegacyIdAction() {
	    super(V2);
	  }
	  
	  public LegacyIdAction(int defaultVersion) {
	  ...
	  public DefaultHttpHeaders show() throws IOException, ServiceException {
	    ...
	    List<AgencyMetadata> agencyMetadata =  _agencyMetadataService.getAgencyMetadataForLegacyId(id);
