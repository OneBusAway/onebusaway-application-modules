...
public class ExceptionInterceptor extends AbstractInterceptor {
  ...
  protected ResponseBean getExceptionAsResponseBean(Exception ex) {
    if (ex instanceof NoSuchStopServiceException || ex instanceof NoSuchTripServiceException
      ...
      return new ResponseBean(_version, ResponseCodes.RESPONSE_RESOURCE_NOT_FOUND, ex.getMessage(), null);
    else
      return new ResponseBean(_version, ResponseCodes.RESPONSE_SERVICE_EXCEPTION, ex.getMessage(), null);
  }
