...
import org.onebusaway.webapp.services.resources.ResourcePrototype;
...
public class ImmutableResourceBundleImpl implements ImmutableResourceBundle,
  ...
  private Map<String, ResourcePrototypeImpl> _resources = new HashMap<String, ResourcePrototypeImpl>();
  ...
  public void addResource(ResourcePrototypeImpl resource) {
    _resources.put(resource.getName(), resource);
  }

  public void refreshAll() {
    for (ResourcePrototypeImpl resource : _resources.values())
      resource.refresh();
  }
