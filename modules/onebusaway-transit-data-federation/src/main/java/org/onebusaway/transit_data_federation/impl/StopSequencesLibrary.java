...
@Component
public class StopSequencesLibrary {

  private static final AgencyAndId NO_SHAPE_ID = new AgencyAndId("no agency", StopSequencesLibrary.class.getName()
      + ".noShapeId");

  private static final String NO_DIRECTION_ID = StopSequencesLibrary.class.getName() + ".noDirectionId";
