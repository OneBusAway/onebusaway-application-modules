...
import org.onebusaway.webapp.gwt.mobile_application.control.RecentStopsListViewModel;
...
public class RecentStopsViewController extends ListViewController {

  public RecentStopsViewController() {
    setModel(new RecentStopsListViewModel());
    
    getNavigationItem().setTitle("Recent Stops");
    getNavigationItem().setRightBarButtonItem(
        new BarButtonItem("Clear", new ClearRecentStopsHandler()));
  }
  ...
  private class ClearRecentStopsHandler implements ClickHandler {

    @Override
    public void onClick(ClickEvent arg0) {
      MobileApplicationDao dao = MobileApplicationContext.getDao();
      dao.clearRecentStops();
      refreshModel();
    }
