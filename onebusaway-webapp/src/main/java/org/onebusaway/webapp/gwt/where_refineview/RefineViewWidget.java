...
public class RefineViewWidget extends Composite {
  ...
  @UiField
  Anchor _addStopAnchor;

  @UiField
  FlowPanel _stopsPanel;
  ...
  private Map<String, StopBean> _stopsById = new HashMap<String, StopBean>();

  private Map<String, Boolean> _routeSelectionById = new HashMap<String, Boolean>();
  ...
  private void loadInitialStopsAndRoutes() {
    ...
    if (map.containsKey("id")) {
      ...
      List<String> stopIds = map.get("id");
  ...
  void handleAddStopClick(ClickEvent e) {
    e.preventDefault();
