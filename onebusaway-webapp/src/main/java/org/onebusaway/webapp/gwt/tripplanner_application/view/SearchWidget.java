...
import org.onebusaway.webapp.gwt.common.resources.greenmarker.GreenMarkerNumberResources;
...
public class SearchWidget extends FlowPanel {
  ...
  public void setAddressError(boolean isDestination) {
    ...
    String txt = isDestination ? "Could not find destination address"
        : "Could not find start address";
  ...
  public void setMultipleAddresses(boolean isDestination,
    ...
    for (int i = 0; i < locations.length(); i++) {
      ...
      AddressClickHandler handler = new AddressClickHandler(isDestination,
          location);
      mainAddressLabel.addClickHandler(handler);
  ...
  private class AddressClickHandler implements ClickHandler, MarkerClickHandler {
