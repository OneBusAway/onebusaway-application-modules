...
/**
 * While the name of this class specifies "WeekdaySchedule", it is actually 
 * building a query specifically for a Wednesday.
 * 
 * @author jpearson
 *
 */
public class WeekdayScheduleCheckServiceImpl extends
  ...
  public String buildQuery(String envURI, String apiKey, String apiQuery,
    ...
    String query = envURI;
    String date = DATE_FLD + getNextDayOfWeek(Calendar.WEDNESDAY) + "&";
