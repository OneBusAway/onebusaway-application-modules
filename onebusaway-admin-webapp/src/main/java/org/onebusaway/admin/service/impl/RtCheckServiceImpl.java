...
public class RtCheckServiceImpl extends BundleValidationCheckServiceImpl {

  @Override
  public String buildQuery(String envURI, String apiKey, String apiQuery,
      String siriQuery, ParsedBundleValidationCheck check) {
    String query = envURI;
    query += siriQuery + STOP_MONITORING + "key=" + apiKey + "&MonitoringRef="
        + check.getStopId() + "&type=json";
    return query;
  }
}
